...
const HeroSection = () => {
    return (<>
        <div className="relative w-full h-screen flex items-center justify-center">
            ...
            <div className='absolute inset-x-12 -bottom-14 h-40  rounded-xl border-solid bg-slate-50  text-grey-900 flex items-center justify-center gap-x-32 text-xl font-medium
