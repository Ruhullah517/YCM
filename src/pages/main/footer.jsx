        ...
        <footer className="bg-slate-50 text-zinc-800 py-10 px-5">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap">
                ...
                <div className="mb-6 md:mb-0 md:w-1/3 pl-9">
                    <h3 className="font-semibold mb-2 text-3xl text-gray-700">Quick Links</h3>
                ...
                <div className="mb-6 md:mb-0 md:w-1/3 pl-9">
                    <h3 className="font-semibold mb-2 text-3xl text-gray-700">Site Policy</h3>
                    <ul className="text-lg space-y-1 text-gray-700">
                ...
                <div className="md:w-1/3">
                    <h3 className="font-semibold mb-2 text-3xl text-gray-700">Let's Get In Touch</h3>
